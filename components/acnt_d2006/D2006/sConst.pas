...
type
  TsCaptionLayout = (sclLeft, sclTopLeft, sclTopCenter, sclTopRight, sclLeftTop, sclBottomLeft, sclBottomCenter, sclBottomRight, sclRight, sclRightTop, sclLeftLeft);
{$IFNDEF FPC}
...
var
  ...
  ac_OldGlyphsMode:      boolean = False;   // Drawing of glyhs in comboedits from old resources
